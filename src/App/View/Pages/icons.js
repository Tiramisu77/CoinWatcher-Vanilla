export const bell = `<svg class="alert-bell" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 459.3 459.3">
...
export const trashcan = `<svg class="trashcan clickable"  xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
